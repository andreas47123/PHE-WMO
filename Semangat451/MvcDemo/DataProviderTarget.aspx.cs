...
public partial class DataProviderTarget : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        using (SqlConnection conn = new SqlConnection(connStr))
        {
            ...
            while (i <= tempi)
            {
                ...
                xmlStr.AppendFormat("<dataset seriesname='{0}' showValues='1'>", f[i]);
                ...
                while (rst2.Read())
                {
                    ...
                    if (yvon >= 800)
                    {
                        xmlStr.AppendFormat("<set value='{0}' link='../Home/Index?field={1}' color='#00ff00'/>", yvon.ToString(), f[i]);
                    }
                    else
                    {
                        xmlStr.AppendFormat("<set value='{0}' link='../Home/Index?field={1}' color='#ff0000'/>", yvon.ToString(), f[i]);
                    }
                }
